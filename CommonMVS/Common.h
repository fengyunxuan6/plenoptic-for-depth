...
#else
#ifndef MVS_VERBOSITY_LEVEL
namespace SEACAVE { extern int g_nVerbosityLevel; }
#define MVS_VERBOSITY_LEVEL g_nVerbosityLevel
#endif
#define VERBOSE LOG
#define DEBUG_LEVEL(n,...)	{ if (n < MVS_VERBOSITY_LEVEL) VERBOSE(__VA_ARGS__); }
#endif
...
extern String g_strSceneImagesFolder; // ͼ������·������ ��/images�� Ϊ��ֹ�ź�
}
