        ...
        */
        ...
        static bool renameFile(LPCTSTR source, LPCTSTR target) {
            if (!::MoveFile(source, target))
            {
                ...
                //std::cout << "MoveFile Failed, error code is " << error_code << std::endl;
                // Can't move, try copy/delete...
                if (!::CopyFile(source, target, FALSE))
                {
                    DWORD error_code = GetLastError();
                    //std::cout << "CopyFile Failed, error code is " << error_code << std::endl;
                    return false;
                }
                ...
                {
                    DWORD error_code = GetLastError();
                    //std::cout << "DeleteFile Failed, error code is " << error_code << std::endl;
                    return false;
                }
                //deleteFile(source);
            }
